...
#define RELAY_PIN 8
#define DEFAULT_READ_TEMP_TIMER 10000
#define DEFAULT_RECYCLE_DELAY 900000
#define DEFAULT_HEAT_TIME 3600000
...
myDelay read_temp_timer = myDelay(read_temp_delay); // Check Temperatures every 10 seconds 10000
myDelay heat_on_timer = myDelay(active_delay);      // Keep heat on for 1 hour 60*60*1000 = 3600000
